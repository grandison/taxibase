...
class Taxist < ActiveRecord::Base
  ...
  has_many :autos
  has_many :taxist_photos
  accepts_nested_attributes_for :addons, :taxist_relatives, :accidents, :reputations, :pasport_scans, :autos, :taxist_photos
